...
class MockTimeProvider: BabulTimeProvider {
    var date: Date?
...
class Mockdelegate: BabulConditionEvaluatorDelegateProtocol {
    ...
    func didFinishTriggerConditionValidation(for campaign: String, with result: Result<AndOrTree.BabulTriggerConditionValidationResult, Error>) {
        switch result {
        case .success(_):
